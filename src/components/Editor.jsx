    ...
    <>
      ...
      <CSS.Main>
        <CSS.Form onSubmit={(e) => e.preventDefault()}>
          모집글 제목
          <CSS.EditorInput value={title} onChange={onChangeTitleHandler} />
          모집글 내용
          <CSS.EditorTextarea
            value={content}
        ...
        <CSS.ButtonBox>
          <Button size="150" type="positive" onClick={onClickSavePosting}>
            저장하기
          </Button>
          <Button size="150" type="negative">
            취소하기
          </Button>
        </CSS.ButtonBox>
      </CSS.Main>
